...
- **The unsayable test: say the sentence out loud to a person** (Zach, Aug 7 2026). Demo and workshop prose gets said to a room. A word fails as a mouthful ("adjudication" — "i can barelu say adjudication") or as gross by connotation ("messy tail" — "evocative of shit"). Use the word you'd use in a meeting: claims are processed or paid, unclear ones are flagged and sent to an examiner. "Escalation" passed his read and is fine.
