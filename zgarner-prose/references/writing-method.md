...
- **Mark a negative as negative before you give it.** When you must show a bad example, say it is bad first, then show it. "It's bad to say X" reads clean. Leading with X and revealing "that was skeeze" at the end plants X as good, then yanks it back. That is staging and a small backfire (Zach, Jul 2026, after "We watch two numbers" got planted as a power sentence before the reveal).
